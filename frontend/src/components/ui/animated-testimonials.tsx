...
const AnimatedTestimonials = ({
  ...
  const randomRotateY = useCallback(() => (typeof window === 'undefined')
    ? 11
  ...
  return (
    <div className="mx-auto max-w-sm px-8 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
...
export default dynamic(() => Promise.resolve(AnimatedTestimonials), {
  ssr: false,
});