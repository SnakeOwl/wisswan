        ...
        <main>
            ...
            <section>
                ...
                <section>
                    ...
                    <section>
                        <h4>Деление дробного на целое</h4>
                    ...
                    <section>
                        <h4>Деление дробного на дробное</h4>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>Переносим запятую вправо на 3 цифры, тогда: <span className="font-bold">261 / 3 = 87</span></p>
                            </li>
                            <li>
                ...
                <section>
                    <ContentDividerV1>
                        <h3 className="w-fit text-wrap xl:text-nowrap">Умножение дробных чисел</h3>
                    </ContentDividerV1>
                    <section>
...
const Drobi = () => {
    return (
        <section id="Drobi">
            ...
            <section>
                <h3>Общее правило приведения дробей к общему знаменателю</h3>
            ...
            <section>
                <h3>Правило сложения дробей с одинаковыми знаменателями</h3>
            ...
            <section>
                <h3>Правило вычитания дробей с одинаковыми знаменателями</h3>
            ...
            <section>
                <h3>Правило сложения | вычитания дробей с разными знаменателями</h3>
            ...
            <section>
                <h3>Сложение | вычитание смешанных чисел</h3>
                <p>При сложении | вычитании смешанных чисел целые и дробные части складываются | вычитаются отдельно:</p>

                <Table className="text-base table-fixed w-full max-w-[1000px] mx-auto">
            ...
            <section id="rule_for_multiplying_common_fractions">
                <h3>Правило умножения обыкновенных дробей</h3>
                Алгоритм такой:
                <ol className="list-decimal list-inside">
            ...
            <section>
                <h3>Правило умножения смешанных чисел</h3>
                <p>Алгоритм такой:</p>
                <ol className="list-decimal list-inside">
            ...
            <section>
                <h3>Правило деления обыкновенных дробей</h3>
