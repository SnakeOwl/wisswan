...
export default function Numbers() {
    return (
        <div>
            ...
            <section>
                <ContentDividerV1 className='my-4'>
                    <h3 id="Numbers-defines" className="w-fit text-xl text-wrap xl:text-nowrap">Определения</h3>
                </ContentDividerV1>
...
const ShortMultipliesFormulas = () => {
    ...
    return (
        <section>
            <ContentDividerV1>
                <h3 id="Numbers-ShortMultipliesFormulas" className="w-fit text-xl text-wrap xl:text-nowrap">Формулы сокращённого умножения</h3>
            </ContentDividerV1>
