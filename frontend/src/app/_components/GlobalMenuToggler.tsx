...
export default function GlobalMenuToggler({
    ...
    return (
        ...
        >
            <div
                ref={line1Ref}
                className="bg-neutral-800 absolute top-[5px] w-[18px] h-[2px] max-h-4 duration-300"
            ></div>
            <div
                ref={line2Ref}
                className="bg-neutral-800 absolute top-[11px] w-[18px] h-[2px] max-h-4 duration-300"
            ></div>
            <div
                ref={line3Ref}
                className="bg-neutral-800 absolute top-[17px] w-[18px] h-[2px] max-h-4 duration-300"
            ></div>
        </button>
    )
}